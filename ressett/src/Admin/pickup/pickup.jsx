...
export default function Pickup() {
  ...
  const gback = () => {
    navigate("/radha/pendingcompletesection/drop");
  };
return (
    <>
...
<button  variant="outlined"  className='buttonSubmit ' onClick={gback} style={{width : "20rem",display:"flex",justifyContent:"center" , alignContent:"center",borderRadius:"1rem" }}> Move to Drop Location & Details </button>
</div>
      </div>
